	...
	#define STR0010 "(1) Descripción                Horas      % (2) Descripción                Horas      %  (3) Descripción                Horas      %"
	#define STR0011 "Matríc Nombre                Período  Hrs.Prev.  Hrs.Real     %  (1)Hrs.Adic.     %  (2)Hrs.N.Trab.     %  (3)Hrs.Abonadas     %   "
	#define STR0014 " Turno: "
	#define STR0015 "TOTALES PARA SUCURSAL "
	#define STR0016 "Período     Hrs.Prev.     Hrs.Real       % (1)Hrs.Adic.      % (2)Hrs.N.Trab.      % (3)Hrs.Abonadas      %"
	#define STR0017 "(1) Descripción                Horas      % (2) Descripción                Horas      %  (3) Descripción                Horas      %"
	...
	#define STR0030 "C.C.: "
	#define STR0031 "Período       Hrs.Prev.     Hrs.Real       % (1)Hrs.Adic.      % (2)Hrs.N.Trab.      % (3)Hrs.Abonadas      %"
	#define STR0032 "Inconsistencia"
	#define STR0033 "Período suministrado no válido"
	#define STR0034 "Seleccione la opcion de impresión"
