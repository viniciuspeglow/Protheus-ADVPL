#ifdef SPANISH
	#define STR0001 "Control de saldo de retención de COFINS"
...
#else
	#ifdef ENGLISH
		#define STR0001 "Control of COFINS Withholdings balance"
	...
	#else
		#define STR0001 "Controle de Saldo de retenção da COFINS"
