	...
	#define STR0028 "NUM LIQUIDAÇÃO"
	#define STR0029 "LIQUIDADO"
	#define STR0030 "No fue posible elaborar la tabla temporal, por favor, verifique su entorno Protheus."
#else
	#ifdef ENGLISH
		...
		#define STR0028 "SALE NUMBER"
		#define STR0029 "SETTLED"
		#define STR0030 "Could not build temporary table, please check your Protheus environment."
	#else
		...
		#define STR0028 "NUM LIQUIDAÇÃO"
		#define STR0029 "LIQUIDADO"
		#define STR0030 "Não foi possivel montar a tabela temporaria, favor verificar o seu ambiente Protheus."
	#endif
#endif
