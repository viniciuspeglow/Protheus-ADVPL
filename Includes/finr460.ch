	...
	#define STR0033 "SmartClient incompatible"
	#define STR0034 "Ocurrencia:"
	#define STR0035 "El SmartClient utilizado está en la versión 64 bits."
	#define STR0036 "Solución:"
	#define STR0037 "Para el correcto funcionamiento de esta rutina, será necesario modificar la versión del"
	#define STR0038 "SmartClient para Lobo Guará 32 bits."
	#define STR0039 "Obs. Los archivos están disponibles en el Portal del Cliente."
#else
	#ifdef ENGLISH
		...
		#define STR0035 "SmartClient used is the 64 bit version."
		#define STR0036 "Solution:"
		#define STR0037 "For the proper functioning of this routine, switch to the version"
		#define STR0038 "Lobo Guará 32 bits of the SmartClient."
		#define STR0039 "Note The files are available in the Customer Portal"
	#else
		...
		#define STR0033 "SmartClient Incompatível"
		#define STR0034 "Ocorrência:"
		#define STR0035 "O SmartClient utilizado está na versão 64 bits."
		#define STR0036 "Solução:"
		#define STR0037 "Para o correto funcionamento dessa rotina, será necessário alterar a versão do"
		#define STR0038 "SmartClient para Lobo Guará 32 bits."
		#define STR0039 "Obs. Os arquivos estão disponíveis no Portal do Cliente."
	#endif
#endif
